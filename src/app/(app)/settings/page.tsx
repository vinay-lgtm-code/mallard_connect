  ...
  return (
    <div className="flex items-start justify-between gap-4 py-4 border-b border-border last:border-0">
      ...
      <button
        ...
        className={`relative flex-shrink-0 w-10 h-6 rounded-full transition-colors focus:border-primary focus:outline-none focus:ring-[3px] focus:ring-primary/10 focus:ring-offset-2 ${
    ...
    <div className="space-y-5">
      <div className="bg-white rounded-[12px] p-5 border border-border">
        ...
        <div className="space-y-4 mt-4">
          <div>
            <label className="block text-xs font-medium text-text-secondary mb-1.5" htmlFor="fullName">
              Full Name
            </label>
            <input
              id="fullName"
              ...
              className="w-full border border-border rounded-lg px-3 py-2.5 text-sm text-text-primary focus:border-primary focus:outline-none focus:ring-[3px] focus:ring-primary/10"
          ...
          <div>
            ...
            <input
              ...
              value={email}
              readOnly
              className="w-full border border-border rounded-lg px-3 py-2.5 text-sm text-text-muted bg-page cursor-not-allowed"
            />
            <p className="text-xs text-text-muted mt-1">Email cannot be changed here.</p>
          </div>

          <div>
            <label className="block text-xs font-medium text-text-secondary mb-1.5" htmlFor="phone">
              Phone Number
            </label>
            <input
              id="phone"
  ...
  return (
    <div className="space-y-5">
      <div className="bg-white rounded-[12px] p-5 border border-border">
        ...
        <div className="space-y-2">
          {stages.map((stage, index) => (
            <div
              key={stage.id}
              className="px-3 py-3 border border-border rounded-lg"
            >
              <div className="flex items-center gap-3">
                ...
                />
                <span className="flex-1 text-sm text-text-primary font-medium">{stage.name}</span>
                {stage.isTerminal && (
                  <span className="text-xs text-text-muted bg-page px-2 py-0.5 rounded">Terminal</span>
                )}
                <div className="flex items-center gap-1">
                  <button
                    onClick={() => moveStage(index, "up")}
                    disabled={index === 0}
                    className="p-1 rounded hover:bg-page disabled:opacity-30"
                    title="Move up"
                  >
              ...
              <div className="flex flex-wrap items-end gap-3 mt-3 pl-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="—"
                    className="w-24 border border-border rounded-lg px-2.5 py-1.5 text-sm text-text-primary focus:border-primary focus:outline-none focus:ring-[3px] focus:ring-primary/10"
                  />
                </div>
                <div>
                  <label className="block text-[11px] font-medium text-text-secondary mb-1">
                  ...
                  <input
                    ...
                    className="w-24 border border-border rounded-lg px-2.5 py-1.5 text-sm text-text-primary focus:border-primary focus:outline-none focus:ring-[3px] focus:ring-primary/10 disabled:bg-page disabled:text-text-muted"
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-medium text-primary border border-border rounded-lg px-3 py-2 hover:bg-page disabled:opacity-50"
                >
      ...
      <div className="bg-white rounded-[12px] p-5 border border-border">
        ...
        <div className="space-y-4 mt-4">
          <div>
            <label className="block text-xs font-medium text-text-secondary mb-1.5">Stage Name</label>
            <input
              type="text"
              value={newStageName}
          ...
          <div>
            <label className="block text-xs font-medium text-text-secondary mb-2">Stage Color</label>
  ...
  return (
    <div className="space-y-5">
      <div className="bg-white rounded-[12px] p-5 border border-border">
        ...
        <p className="text-xs text-text-secondary mb-4 mt-1">Choose which events trigger an email to you.</p>
